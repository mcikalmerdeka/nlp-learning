...
## Latency[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#latency "Direct link to Latency")
...
TPOT=Total Output Tokens−1E2EL – TTFT​
...
![llm-inference-ttft-latency.png](https://bentoml.com/llm/assets/images/llm-inference-ttft-latency-3419154284149af2052def0403380a30.png)
...
### Understanding mean, median, and P99 latency[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#understanding-mean-median-and-p99-latency "Direct link to Understanding mean, median, and P99 latency")
...
## Throughput[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#throughput "Direct link to Throughput")
...
![bento-different-inference-optimizations.png](https://bentoml.com/llm/assets/images/bento-different-inference-optimizations-994c6c7c30556c544de095f962a682ea.png)
[Talk to us](https://l.bentoml.com/contact-us-llm-inference-handbook)
## Goodput[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#goodput "Direct link to Goodput")
...
## Latency vs. throughput tradeoffs[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#latency-vs-throughput-tradeoffs "Direct link to Latency vs. throughput tradeoffs")
...
## Additional resources[​](https://bentoml.com/llm/inference-optimization/llm-inference-metrics#additional-resources "Direct link to Additional resources")
...
[Previous Inference optimization](https://bentoml.com/llm/inference-optimization)[Next LLM performance benchmarks](https://bentoml.com/llm/inference-optimization/llm-performance-benchmarks)
